                        ...
                        <div id="login" class="animate form">
                            <form  method="post" action="Login"> 
                                ...
                                <p> 
                                    ...
                                    <input id="password" name="pwd" required type="password" placeholder="eg. X8df!90EO" /> 
                                </p>
                              <!--  <p class="keeplogin"> 
                                ...
                                <p class="login button"> 
                                    <input type="submit" type="submit" value="Login" onclick="return checkValues();" /> 
								</p>
								<% if((request.getParameter("invalid") != null)){ %>
				<br/><a href="#">Invalid username / password</a>
				<%} %>
							<% if((request.getParameter("newsignup") != null)){ %>
				<br/><a href="#">Regester Succesfully</a>
				<%} %>
                                <p class="change_link">
									Not a member yet ?
									<a href="signup.jsp" class="to_register">Sign Up</a>
								</p>
                            </form>
                        </div>
