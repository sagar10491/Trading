			...
			<div class="span12">
				...
				<div class="sidebar-nav">
					<ul class="nav nav-stacked left-menu">
						...
						<li class="accordion active" id="navigation-sample-pages">
...
Number of trades on page
<select id="selectNumTrade" onchange="fun_hideShowRow(this)">
<option>2</option>
...
<h4 class="title">Indices</h4>
							<div class="squiggly-border"></div>
<table class="flat-table flat-table-1" id="table" style="margin-left:10px">
	<thead >
	<tr>
		<th>Trade</th>
		<th>Signal Rate</th>
	...
	<tbody>
			<%
				int i = 0;
				int count = 0 ;
					Map<String, Float> map = mainMap.get("indices");
		...
		<tr <% if(count > 4) out.println("style='display:none'"); count++; %> >
	...
	<%		}else {
		...
		<%
			...
			%>
			<td><select name="tardeAmount" class="tdrop" style="color: #000;">
          ...
          </select><br /><label style="font-size:14px; color: #CCC;">Trade percentage: 
          <%=
          productData.getRules().getProfit()
          %></label></td>
			<td><input type="submit" class="btrade" style="color:#000; width:200px; height:50px;"  value="Trade"></td>
		</tr>
		</form>
		<%}} else { %>
