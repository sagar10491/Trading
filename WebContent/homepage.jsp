		...
		<div class="navbar-inner black-gradient">
			<div class="container-fluid">
				...
				<!--	<ul class="stats-sparkline pull-left hidden-phone hidden-tablet">
						<li>
							<span class="line-sparkline">Loadingâ¦</span>
							<span class="sparkline-text">Traffic</span>
						</li>
						<li>
							<span class="bar2-sparkline">Loadingâ¦</span>
							<span class="sparkline-text">Tickets</span>
						</li>
						<li>
							<span class="discrete-sparkline">Loadingâ¦</span>
							<span class="sparkline-text">Sales</span>
						</li>
						<li>
							<span class="bar1-sparkline">Loadingâ¦</span>
			...
			<div class="span12">
				...
				<div class="sidebar-nav">
					<ul class="nav nav-stacked left-menu">
						<li id="navigation-index"><a href="homepage.jsp"> <span
								class="hidden-tablet hidden-phone">Home</span> </a>
						</li>
								...
								<div id="collapse1" class="accordion-body collapse">
									<ul class="nav nav-stacked submenu">
										<li><a href="tradepage.jsp"> <span
												class="hidden-tablet hidden-phone">CURRENCIES</span> </a>
										</li>
										<li><a href="stock.jsp"> <span
												class="hidden-tablet hidden-phone">STOCK</span> </a>
										</li>
										<li><a href="indices.jsp"> <span
												class="hidden-tablet hidden-phone">INDICES</span> </a>
										</li>
										<li><a href="commodities.jsp"> <span
												class="hidden-tablet hidden-phone">COMMODITIES</span> </a>
										</li>
										<li class="submenu-last"><a href="pairs.jsp"> <span
												class="hidden-tablet hidden-phone">PAIRS</span> </a>
										</li>
									</ul>
								</div> </a>
						</li>
						<li id="navigation-graphs"><a href="bookTrade.jsp"> <span
								class="hidden-tablet hidden-phone">Book Trade</span> </a>
						</li>
						<li id="navigation-graphs"><a
							href="<%=session.getAttribute("website").toString() %>" target="_blank"> <span
								class="hidden-tablet hidden-phone">Deposit</span> </a>
						</li>
						<li id="navigation-graphs"><a href="profile.jsp"> <span
								class="hidden-tablet hidden-phone">My Profile</span> </a>
						</li>
					...
					<div class="row-fluid">
						<div class="span12">
							<div class="hero-unit" style="border: 0px">
								...
								<h1>Welcome To The Income Rush App!</h1>
								<p>If this is your first time here, welcome and congratulations for getting in. This software is amazing and we’ve invested over half a million dollars to make this a money making software for you and other people who are using this. 
</p> <br/>
<p>Make sure to deposit as much as you can into your balance so you’ll always have enough balance to run the most profitable trades of the day.
</p><br/>
<p><b>This software works on complete autopilot, which means it will automatically trade once per day every day for you.</b> This is what we recommend for our users -- but you can turn this feature off in the My Profile page.
</p><br/>
<p>We also recommend you to check out our “Trade of The Day” -- which is the trade shown above here. This is the best trade of the hour that you can trade and all you need to do is just hit the yellow button to start.
</p> <br/>
<p>If you have any question at all, please do not hesitate to email us at <a href="mailto:support@income-rush.com">support@income-rush.com</a> 
</p> </br>
<p>We’ll be more than happy to assist you.
</p><br/><br/>
<p>- Sam Becker
</p></br>
<p>CEO of Income Rush</p>
</br>
...
%>
												<table class="flat-table flat-table-1" id="table">
													...
													<tbody>
														...
														<%
				ProductData productData = CountSignals.productData;
...
<td style="color: #FF0014;"><%=CountSignals.readSignal(productData.getId())%><img src="down.png" width="20px" style="float: right; margin-left: -30px;" /></td>
																<%		}else {
		%>
<td style="color: #0F0;"><%=CountSignals.readSignal(productData.getId())%><img src="up.png" width="20px" style="float: right; margin-left: -30px;" /></td>
																<%
			}
			%>
																...
																</select><br /> <label style="font-size: 14px; color: #CCC;">Trade
																		percentage: 
	 <%=
          productData.getRules().getProfit()
          %> </label></td>
...
<tr> <td> No tradeable product is available </td></tr>
		...
		<script type="text/javascript">
			...
			function get_flot_colors() {
				...
				return [ '#49AFCD', '#FF6347', '#38849A', '#BF4A35', '#999',
						'#555' ];
			}
			...
			jQuery(function($) {
				...
				$('.discrete-sparkline').sparkline(
						[ 12, 11, 13, 14, 13, 12, 11, 12, 13, 14, 15, 16, 15,
				...
				$('.line-sparkline').sparkline(
						[ 12, 11, 13, 14, 13, 12, 11, 12, 13, 14, 15, 16, 15,
								14, 13, 12, 11, 12, 13, 14, 15, 16, 17, 18 ], {
							type : 'line',
							lineColor : sparkline_colors[0],
...
<![endif]-->
	...
	jQuery(function($){
	  ...
	  <div id="dialog" title="" style="paddin:200px 250px;height:80%;width:80%">
  
 <a href="<%=session.getAttribute("website").toString() %>" target="_blank"><img  src="popup.png" style="width:800px;height:500px;margin:50px;margin-left:80px;"></a>
</div>
</body>
</html>
	<%} %>